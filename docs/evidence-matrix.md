...
| Scrapers in CI | Scheduled/manual workflow with green validation | `.github/workflows/collect.yml` and Action run | green refresh run `32551530109`; quality runs `32552183005` and `32552183008` |
...
| Goal/schedule | One bounded market/source slice runs unattended on schedule | `.github/workflows/collect.yml`, Action summary | green refresh run `32551530109`; hosted PostgreSQL is reached through private Hyperdrive |
