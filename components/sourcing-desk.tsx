...
import { buildSourcingBrief, canonicalizeStored, isSafeUrl, selectSourceDeskOffer, serializeSourceDesk, SOURCE_DESK_LIMIT, type SourceDeskOffer } from "./sourcing-desk-model";
