...
export const sourceRegistry = {
  ...
  tradezone: {
    slug: "tradezone",
    displayName: "Tradezone SG",
    role: "secondary",
    region: "SG",
    currency: "SGD",
    baseUrl: "https://tradezone.sg",
    allowedHosts: ["tradezone.sg", "www.tradezone.sg"],
    catalogUrl: "https://tradezone.sg/product-category/pc-related/pc-parts/graphic-card/",
    enabled: false,
    collectorIds: {},
    collectorRoles: ["combined"],
  },
